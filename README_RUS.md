...
В этом случае нажатие на ссылку в виде стрелки вверх напротив zip архива приведёт к распаковке этого архива в текущую директорию.
...
![Запрос на ввод имени пользователя и пароля](https://github.com/Mendeo/web-shared-folder/blob/dev/img/screenshot_authentication_required.png)  
