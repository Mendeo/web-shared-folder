...
In order to allow users not only download files and folders from server, but also upload it to the server, it is necessary to set the environment variable **SERVER_UPLOAD_ENABLE** to 1. **The maximum upload size at one time is about 2 GiB.**
